...
export const LoadingState = memo(({ message = "Loading content..." }) => (
...
export const EmptyState = memo(({ title = "No data found", description = "There are no records to display right now." }) => (
...
export const ErrorState = memo(({ title = "Something went wrong", message = "Unable to load data.", onRetry }) => (
