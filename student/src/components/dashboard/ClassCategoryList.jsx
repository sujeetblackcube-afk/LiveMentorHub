        ...
        <div className="flex flex-wrap gap-3.5 mb-10">
          {classes.map((classItem) => {
            ...
            return (
              ...
              >
                <AppWindow className={`h-[18px] w-[18px] ${isActive ? 'text-[#0d1f5c]' : 'text-[#0d1f5c]'}`} />
              ...
              {activeClass.subjects?.map((subject) => {
                return (
                  <Link
                    ...
                    to={`/courses?subject=${encodeURIComponent(subject.subjectName)}&class=${encodeURIComponent(activeClass.className)}`}
