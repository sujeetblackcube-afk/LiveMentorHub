...
export function Navbar() {
  ...
  const GUEST_NAV_LINKS = [
    { label: "Home", href: "/auth/login" },
    { label: "Courses", href: "/courses?demo=true" },
  ];
          ...
          <Link to="/dashboard" className="flex items-center gap-3 group">
            <div className="bg-white/50 rounded-xl border border-gray-100 shadow-sm w-12 h-10 flex items-center justify-center overflow-hidden">
              <img
                ...
                height={120}
                loading="eager"
                className="w-auto h-10 object-contain transform group-hover:scale-105 transition-transform duration-300"
              />
            </div>
