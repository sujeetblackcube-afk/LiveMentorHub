    ...
    <footer className="bg-[#0a1540] text-white/60">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Col 1 — Logo + Tagline */}
          <div>
            <Link to="/dashboard" className="flex items-center gap-4 mb-6 group text-xl font-bold text-white">
          ...
          <div className="md:flex md:justify-center">
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/" className="hover:text-white transition-colors text-sm" style={{ color: 'rgba(255,255,255,0.6)' }}>
                    Home Page
                  </Link>
                </li>
                <li>
                  <Link to="/dashboard" className="hover:text-white transition-colors text-sm" style={{ color: 'rgba(255,255,255,0.6)' }}>
                    Student Dashboard
                  </Link>
                </li>
              </ul>
