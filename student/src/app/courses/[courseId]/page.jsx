...
import { getCourseById, isEnrolledIn, useCoursePageData, fetchCourseContent } from "@/lib/courseData";
...
function SidebarField({ label, value, icon: Icon }) {
    ...
    useEffect(() => {
        ...
        const fetchContent = async () => {
            ...
            try {
                ...
                const data = await fetchCourseContent(activeSid, course.id, activeContentType === 'ALL' ? undefined : activeContentType);
            ...
            <nav className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-xl border-b border-gray-200/50 transition-all">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center gap-4">
                    ...
                    <div className="text-sm font-semibold text-gray-400">
                        <span className="hover:text-[#0d1f5c] cursor-pointer" onClick={() => navigate('/courses')}>Courses</span>
